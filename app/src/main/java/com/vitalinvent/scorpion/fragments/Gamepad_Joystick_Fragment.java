package com.vitalinvent.scorpion.fragments;
...
import com.vitalinvent.scorpion.ClientStatus;
import com.vitalinvent.scorpion.Utility;
import com.vitalinvent.scorpion.activities.GamepadActivity;
...
public class Gamepad_Joystick_Fragment extends CyaneaFragment implements GamepadActivity.JoystickListener, Esp8266ClientAsyncFragment.esp8266ClientListener, ServiceConnection, SerialListener {
//public class Gamepad_Joystick_Fragment extends CyaneaFragment implements GamepadActivity.JoystickListener, ServiceConnection, SerialListener {
...
//    private Esp8266ClientAsyncFragment mAsyncFragment;
    ...
    float translationLeftX;
    float translationLeftY;
    float translationLeftXLast;
    float translationLeftYLast;
    float translationRightX;
    float translationRightY;
    float translationRightXLast;
    float translationRightYLast;
...
//        }
    ...
    public void onAttach(Context context) {
        ...
        args.putString("device", "D0:B5:C2:B9:91:BD");
...
//        }
    ...
    @RequiresApi(api = Build.VERSION_CODES.JELLY_BEAN_MR2)
    private void move() {
        if ((translationLeftX == translationLeftXLast) && (translationLeftY == translationLeftYLast)) {
        } else {
            data = ((int) translationLeftX + ":" + (int) translationLeftY  + ":"  + "#" ).getBytes();
            try {
                service.write(data);
                translationLeftXLast = translationLeftX;
                translationLeftYLast = translationLeftY;
            } catch (IOException e) {
                e.printStackTrace();
            }
        }
        if ((translationRightX == translationRightXLast) && (translationRightY == translationRightYLast)) {
        } else {
            data = ((int) translationRightX  + ":" + (int) translationRightY +
                     ":"  + "R"  + ":" + "#" ).getBytes();
            try {
                service.write(data);
                translationRightXLast = translationRightX;
                translationRightYLast = translationRightY;
            } catch (IOException e) {
                e.printStackTrace();
            }
        }
    ...
    public void onJoystick(float[] joystickData) {
        translationLeftX = Utility.mapFloat(joystickData[0], -1, 1, -40, 40);
        translationLeftY = Utility.mapFloat(joystickData[1], -1, 1, -40, 40);
        mJoystickLeft.setX(translationLeftX + joystickLeft_CenterLocation[0]);
        mJoystickLeft_outline.setX(translationLeftX + joystickLeft_CenterLocation[2]);
        mJoystickLeft_inner.setX(translationLeftX + joystickLeft_CenterLocation[4]);

        mJoystickLeft.setY(translationLeftY + joystickLeft_CenterLocation[1]);
        mJoystickLeft_outline.setY(translationLeftY + joystickLeft_CenterLocation[3]);
        mJoystickLeft_inner.setY(translationLeftY + joystickLeft_CenterLocation[5]);

        tvInfo.setText("x=" + translationLeftX + " y=" + translationLeftY);
...
//        }
        ...
        translationRightX = Utility.mapFloat(joystickData[2], -1, 1, -40, 40);
        translationRightY = Utility.mapFloat(joystickData[3], -1, 1, -40, 40);
        mJoystickRight.setX(translationRightX + joystickRight_CenterLocation[0]);
        mJoystickRight_outline.setX(translationRightX + joystickRight_CenterLocation[2]);
        mJoystickRight_inner.setX(translationRightX + joystickRight_CenterLocation[4]);

        mJoystickRight.setY(translationRightY + joystickRight_CenterLocation[1]);
        mJoystickRight_outline.setY(translationRightY + joystickRight_CenterLocation[3]);
        mJoystickRight_inner.setY(translationRightY + joystickRight_CenterLocation[5]);
...
//            mAsyncFragment.disconnect();
    ...
    private void connect() {
        try {
            ...
            BluetoothDevice device = bluetoothAdapter.getRemoteDevice("D0:B5:C2:B9:91:BD");
